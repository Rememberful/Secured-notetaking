    ...
    <footer className="app-footer">
      <div className="footer-inner">
        <div className="footer-brand">
          <span className="footer-name">Aditya Kumar</span>
          <span className="footer-tagline">Developer</span>
        </div>

        <div className="footer-contact">
          <a href="tel:+917079487671" className="footer-link">
          ...
          <a href="mailto:adii.utsav@gmail.com" className="footer-link">
            <svg className="footer-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="footer-socials">
          <a href="https://www.linkedin.com/in/aditya-kumar-3241b6286/"
            target="_blank"
          ...
          >
           ...
           <a href="https://medium.com/@adii.utsav"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social-link"
            aria-label="Medium"
          ...
          <a
            href="https://github.com/Rememberful/Secured-notetaking"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social-link footer-contribute"
      ...
      <div className="footer-bottom">
        ...
        <a href="https://github.com/Rememberful/secured-messaging" target="_blank" rel="noopener noreferrer">
          View source
        </a>
      </div>
    </footer>
